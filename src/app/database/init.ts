...
exports.init = async (dbConnection:any) =>{
  ...
  const deleteMembersPolicy = new permission({ slug: 'delete:members', description: 'Delete Members' });
  ...
  const addShortcutsPolicy = new permission({ slug: 'add:shortcuts', description: 'Add Shortcuts' });
  const viewShortcutsPolicy = new permission({ slug: 'view:shortcuts', description: 'View Shortcuts' });
  const editShortcutsPolicy = new permission({ slug: 'edit:shortcuts', description: 'Edit Shortcuts' });
  const deleteShortcutsPolicy = new permission({ slug: 'delete:shortcuts', description: 'Delete Shortcuts' });
  ...
  const viewSettingsPolicy = new permission({ slug: 'view:settings', description: 'View Settings' });
  const editSettingsPolicy = new permission({ slug: 'edit:settings', description: 'Edit Settings' });
